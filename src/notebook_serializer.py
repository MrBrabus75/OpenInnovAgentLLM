...
parser.add_argument("-n", "--notebook", help="chemin du notebook", default=None, type=str)
...
if args.notebook:
    ...
    if os.path.exists(notebook_path):
        print(f'le fichier situé {notebook_path} existe déjà, choisissez un autre nom.')
        exit()
